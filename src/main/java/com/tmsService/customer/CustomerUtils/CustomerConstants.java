package com.tmsService.customer.CustomerUtils;

public class CustomerConstants {
    public static final String CARTE_BANCAIRE = "CARTE BANCAIRE";
    public static final String VIREMENT = "VIREMENT";
    public static final String CHEQUE = "CHEQUE";
    public static final String CUSTOMER_NOT_FOUND = "cet Client n'existe pas !";
